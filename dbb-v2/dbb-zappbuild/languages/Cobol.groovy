// merge old deply type into this new ver for cics demos using gl project 
...
sortedList.each { buildFile ->
	println "*** Building (CG V2) file $buildFile"
...
def createLinkEditCommand(String buildFile, LogicalFile logicalFile, String member, File logFile) {
	...
	//njl cg dp to cics for to simplifed ucd genart that also include  bms  
	if (buildUtils.isCICS(logicalFile))	deployType = 'CICS'
