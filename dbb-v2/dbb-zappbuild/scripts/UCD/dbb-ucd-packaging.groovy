...
/**  
 * njl - note copied commit 2bdc924 from https://github.com/IBM/dbb/edit/main/Pipeline/CreateUCDComponentVersion/dbb-ucd-packaging.groovy
 *     - add verb and v2 package which support alias...  
 *     - v2 error - missing deplytype at container 1 (PATCH Added DP at container lvl- testing - UCD deply failed - reverted type1
 *     - CLI TEST /u/ibmuser/ibm-ucd/agent/bin/buztool.sh createzosversion2 -c  poc-component -s /u/ibmuser/CI-PIPELINES-WorkDir/AzDBB_2253/poc-workspace/shiplist.xml -o /u/ibmuser/CI-PIPELINES-WorkDir/AzDBB_2253/poc-workspace/buztool.output  -verb  -v 2253 
...
println("** v2- Create version start at $properties.startTime")
